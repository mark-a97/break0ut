...
public class GameObj
{
    ...
    public boolean brickHit = false;	//Links to if the brick has been previously hit, the player gets more points.
    public boolean brickHealth = false;	//If the brickHealth boolean is set to true, this row of bricks will be able to take
    									//an extra hit
